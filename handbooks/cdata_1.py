...
CDATA["depression"] = dict(
    ...
    modality_table=[
        ["Modality", "Device", "Classification", "MDD Evidence Status"],
        ["tDCS", "Newronika HDCkit / PlatoScience", "CE Class IIa", "Level A evidence (Brunoni 2017 meta-analysis, n>1000)"],
        ["TPS", "NEUROLITH\u00ae (Storz Medical)", "CE Class IIa", "INVESTIGATIONAL \u2014 OFF-LABEL for MDD"],
        ["taVNS", "Nemos / TENS tragus device", "CE-marked (epilepsy/depression)", "Level B evidence; FDA Breakthrough Therapy"],
        ["CES", "Alpha-Stim AID", "FDA-cleared (anxiety/insomnia/depression)", "Level A evidence (Kimchi 2021, Meta-analyses)"],
    ],
    offlabel_table=[
...
CDATA["anxiety"] = dict(
    ...
    modality_table=[
        ["Modality", "Device", "Classification", "GAD Evidence Status"],
        ["tDCS", "Newronika HDCkit / PlatoScience", "CE Class IIa", "Level B evidence (DLPFC anxiolytic effect; Moffa 2020)"],
        ["TPS", "NEUROLITH\u00ae (Storz Medical)", "CE Class IIa", "INVESTIGATIONAL \u2014 OFF-LABEL for GAD"],
        ["taVNS", "Nemos / TENS tragus device", "CE-marked (epilepsy/depression)", "Level B evidence; vagal anti-anxiety mechanism"],
        ["CES", "Alpha-Stim AID", "FDA-cleared (anxiety/insomnia/depression)", "Level A evidence; FDA-cleared for anxiety"],
    ],
    offlabel_table=[
...
CDATA["adhd"] = dict(
    ...
    modality_table=[
        ["Modality", "Device", "Classification", "ADHD Evidence Status"],
        ["tDCS", "Newronika HDCkit / PlatoScience", "CE Class IIa", "Level B evidence (DLPFC; Leffa 2022 meta-analysis)"],
        ["TPS", "NEUROLITH\u00ae (Storz Medical)", "CE Class IIa", "INVESTIGATIONAL \u2014 OFF-LABEL for ADHD"],
        ["taVNS", "Nemos / TENS tragus device", "CE-marked (epilepsy/depression)", "Level C (preliminary; noradrenergic LC mechanism)"],
        ["CES", "Alpha-Stim AID", "FDA-cleared (anxiety/insomnia/depression)", "Level C evidence (sleep/anxiety comorbidity in ADHD)"],
    ],
    offlabel_table=[
...
CDATA["alzheimers"] = dict(
    ...
    modality_table=[
        ["Modality", "Device", "Classification", "AD/MCI Evidence Status"],
        ["tDCS", "Newronika HDCkit / PlatoScience", "CE Class IIa", "Level B evidence (memory; Boggio 2012, Bystad 2016)"],
        ["TPS", "NEUROLITH\u00ae (Storz Medical)", "CE Class IIa", "CE-MARKED for Alzheimer\u2019s Disease \u2014 Level B evidence"],
        ["taVNS", "Nemos / TENS tragus device", "CE-marked (epilepsy/depression)", "Level C (preliminary; hippocampal theta; Jacobs 2015)"],
        ["CES", "Alpha-Stim AID", "FDA-cleared (anxiety/insomnia/depression)", "Level C evidence (sleep/anxiety in AD; Yusupov 2019)"],
    ],
    offlabel_table=[
