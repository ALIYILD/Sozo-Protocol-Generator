...
CDATA["stroke_rehab"] = dict(
    ...
    modality_table=[
        ...
        ["taVNS", "Nemos / TENS tragus device", "CE-marked (epilepsy/depression)", "RCT, Open-label", "25+"],
...
CDATA["chronic_pain"] = dict(
    ...
    modality_table=[
        ...
        ["taVNS", "Nemos / TENS tragus device", "CE-marked (epilepsy/depression)", "RCT, Open-label", "40+"],
        ["CES", "Alpha-Stim AID", "FDA-cleared (anxiety/insomnia/depression)", "RCT, Open-label", "35+"],
...
CDATA["ptsd"] = dict(
    ...
    modality_table=[
        ...
        ["CES", "Alpha-Stim AID", "FDA-cleared (anxiety/insomnia/depression)", "Open-label, Military cohort studies", "10+"],
