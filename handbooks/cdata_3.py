...
CDATA["long_covid"] = dict(
    ...
    modality_table=[
        ...
        ["TPS", "NEUROLITH\u00ae (Storz Medical)", "CE Class IIa \u2014 INVESTIGATIONAL OFF-LABEL", "Investigational", "0+"],
        ["taVNS", "Nemos / TENS tragus device", "CE-marked (epilepsy/depression)", "Open-label, Pilot", "3+"],
        ["CES", "Alpha-Stim AID", "FDA-cleared (anxiety/insomnia/depression)", "Open-label, Observational", "3+"],
...
CDATA["tinnitus"] = dict(
    ...
    modality_table=[
        ...
        ["TPS", "NEUROLITH\u00ae (Storz Medical)", "CE Class IIa \u2014 INVESTIGATIONAL OFF-LABEL", "Investigational", "0+"],
        ["taVNS", "Nemos / TENS tragus device", "CE-marked (epilepsy/depression)", "Open-label, Pilot RCT", "15+"],
        ["CES", "Alpha-Stim AID", "FDA-cleared (anxiety/insomnia/depression)", "Open-label, Pilot", "0+"],
...
CDATA["insomnia"] = dict(
    ...
    modality_table=[
        ...
        ["CES", "Alpha-Stim AID", "FDA-cleared (anxiety/insomnia/depression)", "RCT, Meta-analysis", "25+"],
        ["TMS", "NeuroStar / MagVenture / Magstim", "CE/FDA (research use)", "RCT, Open-label", "5+"],
