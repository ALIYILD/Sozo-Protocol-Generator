...
CDATA = {
    "tbi": {
        ...
        "modality_table": [
            ["Modality", "Device", "Classification", "TBI Status"],
            ["tDCS", "Newronika HDCkit / PlatoScience", "CE Class IIa", "Investigational (Off-Label) — cognitive rehabilitation post-TBI"],
            ["TPS", "NEUROLITH® (Storz Medical)", "CE Class IIa", "INVESTIGATIONAL (Off-Label)"],
            ["taVNS", "Transcutaneous auricular VNS", "CE-marked", "Emerging adjunctive — vagal neuroprotection and pain modulation"],
            ["CES", "Alpha-Stim®", "FDA-cleared", "Investigational (Off-Label) — headache, sleep, mood component"],
        ],
        "offlabel_table": [
    ...
    "chronic_pain": {
        ...
        "modality_table": [
            ["Modality", "Device", "Classification", "Chronic Pain Status"],
            ["tDCS", "Newronika HDCkit / PlatoScience", "CE Class IIa", "Level B evidence — established NIBS for chronic pain and fibromyalgia"],
            ["TPS", "NEUROLITH® (Storz Medical)", "CE Class IIa", "INVESTIGATIONAL (Off-Label) — cranial and peripheral application"],
            ["taVNS", "Transcutaneous auricular VNS", "CE-marked", "Emerging adjunctive — vagal anti-inflammatory and descending inhibition"],
            ["CES", "Alpha-Stim®", "FDA-cleared", "Cleared (FDA 510k) — pain, anxiety, and insomnia indication"],
        ],
        "offlabel_table": [
    ...
    "ptsd": {
        ...
        "modality_table": [
            ["Modality", "Device", "Classification", "PTSD Status"],
            ["tDCS", "Newronika HDCkit / PlatoScience", "CE Class IIa", "Investigational (Off-Label) — prefrontal fear regulation"],
            ["TPS", "NEUROLITH® (Storz Medical)", "CE Class IIa", "INVESTIGATIONAL (Off-Label)"],
            ["taVNS", "Transcutaneous auricular VNS", "CE-marked", "Primary adjunctive — parasympathetic regulation, fear extinction"],
            ["CES", "Alpha-Stim®", "FDA-cleared", "Cleared (FDA 510k) — anxiety indication; supportive for PTSD hyperarousal"],
        ],
        "offlabel_table": [
    ...
    "ocd": {
        ...
        "modality_table": [
            ["Modality", "Device", "Classification", "OCD Status"],
            ["tDCS", "Newronika HDCkit / PlatoScience", "CE Class IIa", "Investigational (Off-Label) — SMA/OFC and DLPFC modulation"],
            ["TPS", "NEUROLITH® (Storz Medical)", "CE Class IIa", "INVESTIGATIONAL (Off-Label)"],
            ["taVNS", "Transcutaneous auricular VNS", "CE-marked", "Emerging adjunctive — autonomic modulation and CSTC regulation"],
            ["CES", "Alpha-Stim®", "FDA-cleared", "Investigational (Off-Label) — anxiety component in OCD"],
        ],
        "offlabel_table": [
    ...
    "ms": {
        ...
        "modality_table": [
            ["Modality", "Device", "Classification", "MS Status"],
            ["tDCS", "Newronika HDCkit / PlatoScience", "CE Class IIa", "Level B evidence — established NIBS for fatigue and motor function in MS"],
            ["TPS", "NEUROLITH® (Storz Medical)", "CE Class IIa", "INVESTIGATIONAL (Off-Label)"],
            ["taVNS", "Transcutaneous auricular VNS", "CE-marked", "Emerging adjunctive — fatigue, autonomic, and neuroinflammation modulation"],
            ["CES", "Alpha-Stim®", "FDA-cleared", "Investigational (Off-Label) — fatigue, depression, and sleep component"],
        ],
        "offlabel_table": [
