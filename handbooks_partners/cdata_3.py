...
CDATA = {
    "asd": {
        ...
        "modality_table": [
            ["Modality", "Device", "Classification", "ASD Status"],
            ["tDCS", "Newronika HDCkit / PlatoScience", "CE Class IIa", "Investigational (Off-Label)"],
            ["TPS", "NEUROLITH® (Storz Medical)", "CE Class IIa", "INVESTIGATIONAL (Off-Label)"],
            ["taVNS", "Transcutaneous auricular VNS", "CE-marked", "Emerging adjunctive — emotional regulation"],
            ["CES", "Alpha-Stim®", "FDA-cleared", "Investigational (Off-Label) — anxiety/sleep component"],
        ],
        "offlabel_table": [
    ...
    "long_covid": {
        ...
        "modality_table": [
            ["Modality", "Device", "Classification", "Long COVID Status"],
            ["tDCS", "Newronika HDCkit / PlatoScience", "CE Class IIa", "Investigational (Off-Label) — brain fog / fatigue"],
            ["TPS", "NEUROLITH® (Storz Medical)", "CE Class IIa", "INVESTIGATIONAL (Off-Label)"],
            ["taVNS", "Transcutaneous auricular VNS", "CE-marked", "Primary adjunctive — vagal/autonomic regulation"],
            ["CES", "Alpha-Stim®", "FDA-cleared", "Investigational (Off-Label) — brain fog, fatigue, mood"],
        ],
        "offlabel_table": [
    ...
    "tinnitus": {
        ...
        "modality_table": [
            ["Modality", "Device", "Classification", "Tinnitus Status"],
            ["tDCS", "Newronika HDCkit / PlatoScience", "CE Class IIa", "Investigational (Off-Label) — auditory cortex modulation"],
            ["TPS", "NEUROLITH® (Storz Medical)", "CE Class IIa", "INVESTIGATIONAL (Off-Label)"],
            ["taVNS", "Transcutaneous auricular VNS", "CE-marked", "Emerging adjunctive — auditory-vagal pathway"],
            ["CES", "Alpha-Stim®", "FDA-cleared", "Cleared (FDA 510k) — anxiety/insomnia comorbidity"],
        ],
        "offlabel_table": [
    ...
    "insomnia": {
        ...
        "modality_table": [
            ["Modality", "Device", "Classification", "Insomnia Status"],
            ["tDCS", "Newronika HDCkit / PlatoScience", "CE Class IIa", "Investigational (Off-Label) — cortical arousal modulation"],
            ["TPS", "NEUROLITH® (Storz Medical)", "CE Class IIa", "INVESTIGATIONAL (Off-Label)"],
            ["taVNS", "Transcutaneous auricular VNS", "CE-marked", "Primary adjunctive — parasympathetic/sleep induction"],
            ["CES", "Alpha-Stim®", "FDA-cleared", "Cleared (FDA 510k) — insomnia indication (primary modality)"],
        ],
        "offlabel_table": [
