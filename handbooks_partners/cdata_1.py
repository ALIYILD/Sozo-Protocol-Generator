...
CDATA = {
    "depression": {
        ...
        "modality_table": [
            ...
            ["taVNS", "Transcutaneous auricular VNS", "CE-marked (epilepsy/depression)", "RCT, Meta-analysis", "80+"],
            ["CES", "Alpha-Stim\u00ae", "FDA-cleared (anxiety/insomnia/depression)", "RCT, Meta-analysis", "30+"],
    ...
    "anxiety": {
        ...
        "modality_table": [
            ...
            ["taVNS", "Transcutaneous auricular VNS", "CE-marked (epilepsy/depression)", "RCT, Open-label", "10+"],
            ["CES", "Alpha-Stim\u00ae", "FDA-cleared (anxiety/insomnia/depression)", "RCT, Meta-analysis", "40+"],
    ...
    "alzheimers": {
        ...
        "modality_table": [
            ...
            ["CES", "Alpha-Stim\u00ae", "FDA-cleared (anxiety/insomnia/depression)", "Open-label, Observational", "0+"],
    ...
    "stroke_rehab": {
        ...
        "modality_table": [
            ["Modality", "Device", "Regulatory", "Evidence Level", "Papers (est.)"],
            ["tDCS", "Newronika HDCkit / PlatoScience", "CE Class IIa", "RCT, Meta-analysis", "100+"],
            ["TPS", "NEUROLITH\u00ae (Storz Medical)", "CE Class IIa \u2014 INVESTIGATIONAL OFF-LABEL", "Investigational", "0+"],
            ["taVNS", "Transcutaneous auricular VNS", "CE-marked (epilepsy/depression)", "RCT, Open-label", "25+"],
            ["CES", "Alpha-Stim\u00ae", "FDA-cleared (anxiety/insomnia/depression)", "Open-label, Pilot", "0+"],
            ["TMS", "NeuroStar / MagVenture / Magstim", "CE/FDA (research use)", "RCT, Meta-analysis", "100+"],
            ["PBM", "Vielight Neuro / Coronet", "CE/FDA (research)", "Open-label, Pilot RCT", "10+"],
            ["PEMF", "BrainsWay / MagPro", "CE/FDA (research)", "RCT, Open-label", "20+"],
        ],
        "best_modality": "TMS, tDCS",
        "offlabel_table": [
