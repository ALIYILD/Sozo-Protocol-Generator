    ...
    return ConditionSchema(
        ...
        protocols=[
            ProtocolEntry(
                ...
                protocol_name='TDCS-LC-COG — Cognitive Brain Fog Protocol',
                clinical_objective='Address cognitive impairment and brain fog in long COVID via DLPFC stimulation',
                ...
                session_structure='Anode (+): F3 (L-DLPFC). Cathode (-): Fp2 or F4 (R-DLPFC). 2 mA, 20 min.',
                frequency='1 session/day, 5 days/week',
                duration='20 min per session',
                intensity_dose='2 mA',
                montage_roi='Anode (+): F3 (L-DLPFC). Cathode (-): Fp2 or F4',
                laterality='Left anodal',
                treatment_course='10-15 sessions over 2-3 weeks',
                monitoring='Impedance check; MoCA; cognitive battery; fatigue scales; skin integrity',
                expected_response='Improved attention, processing speed, and reduced brain fog by Week 2-3',
                evidence_status='Low — emerging case series and pilot data; no RCT for long COVID tDCS',
                cautions='OFF-LABEL. Long COVID is a heterogeneous condition. Screen for depression/anxiety comorbidity. Monitor fatigue.',
                when_to_escalate='If <20% improvement after 10 sessions, add CES or taVNS for autonomic support',
                when_to_stop_modify='Stop if burning, skin lesion, or neurological worsening',
                clinical_notes_extended='Brain fog is the most common long COVID cognitive complaint. Concurrent cognitive rehabilitation exercises recommended.',
                key_citations=['Pilloni et al., 2022'],
            ),
            ProtocolEntry(
                ...
                # Extended protocol fields
                protocol_name='TAVNS-LC — Autonomic & Dysautonomia Protocol',
                clinical_objective='Address autonomic dysfunction and dysautonomia in long COVID via vagal modulation',
                primary_targets=['Left cymba conchae (auricular CN X)'],
                secondary_targets=['Autonomic/parasympathetic rebalancing'],
                ...
                monitoring='Heart rate variability; orthostatic vitals; fatigue scales; skin integrity; tolerability',
                expected_response='Improved autonomic balance and reduced dysautonomia symptoms within 4-6 weeks',
                evidence_status='Low — emerging evidence for taVNS in autonomic dysfunction; limited long COVID data',
                cautions='Left ear only. Monitor heart rate. Adjunct to multidisciplinary long COVID care.',
                when_to_escalate='If no improvement after 8 weeks, reassess diagnosis and consider additional modalities',
                when_to_stop_modify='Stop if bradycardia, ear pain, or symptom worsening',
                clinical_notes_extended='taVNS targets autonomic imbalance (sympathetic predominance) common in long COVID.',
            ...
            ProtocolEntry(
                ...
                # Extended protocol fields
                protocol_name='CES-LC — Sleep, Anxiety & Mood Adjunct',
                clinical_objective='Address sleep disturbance, anxiety, and mood symptoms in long COVID',
                ...
                cautions='Adjunctive only — not primary treatment for long COVID.',
                when_to_escalate='If symptoms persist, add tDCS or taVNS',
                when_to_stop_modify='Stop if skin irritation',
                clinical_notes_extended='Non-pharmacological adjunct for the prevalent sleep/mood/anxiety symptoms in long COVID.',
        ...
        platoscience_variants=[
            PlatoScienceVariant(
                variant_id="C-LC-COG-PS", protocol_id="C-LC-COG",
                label="PlatoScience Cognitive Brain Fog — DLPFC tDCS",
                parameters={"program": "Think", "electrode_config": "F3 (left DLPFC) or F3+F4 bilateral", "intensity": "1.5-2.0 mA (start 1.5 mA; PEM-caution: no concurrent cognitive tasks initially)", "duration": "15-20 min (start 15 min — PEM management)", "ramp": "30 sec"},
                notes="Maps to C-LC-COG protocol. PlatoScience Think program.",
            ),
        ],
        ...
        eeg_reference_table=[
            {
                ...
                "role": 'Anodal — cognitive brain fog target',
                "protocols_using": ['C-LC-COG'],
            },
            {
                "position": 'F4',
                "brain_region": 'Right DLPFC',
                "role": 'Bilateral DLPFC or cathodal reference',
                "protocols_using": ['C-LC-COG'],
            },
            {
                "position": 'Fz',
            ...
            },
            {
                ...
                "role": 'Memory/hippocampal support',
                "protocols_using": [],
            },
            {
                "position": 'T6',
